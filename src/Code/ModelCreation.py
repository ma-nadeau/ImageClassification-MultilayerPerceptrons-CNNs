...
def create_mlp_with_no_hidden_layer(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_single_hidden_layer_of_256_units(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_double_hidden_layer_of_256_units(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_double_hidden_layer_of_256_units_and_leaky_ReLU_activation(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_double_hidden_layer_of_256_and_tanh_activation(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_double_hidden_layer_of_256_units_and_sigmoid_activation(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01, bias=True):
    """
...
def create_mlp_with_double_hidden_layer_of_256_units_and_ReLU_activation_L1(input_size=28 * 28, output_size=11, epochs=30, batch_size=16, learning_rate=0.01,
...
def create_mlp_with_double_hidden_layer_of_256_units_and_ReLU_activation_L2(input_size=28 * 28, output_size=11, epochs=30, batch_size=16,
